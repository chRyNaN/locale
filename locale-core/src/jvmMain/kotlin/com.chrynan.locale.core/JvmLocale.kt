...
class JvmLocale internal constructor(@Suppress("MemberVisibilityCanBePrivate") val jvmLocale: java.util.Locale) :
    Locale {
...
fun Locale.toJvmLocale(): JvmLocale =
    (this as? JvmLocale) ?: JvmLocale(java.util.Locale.forLanguageTag(languageTag))
